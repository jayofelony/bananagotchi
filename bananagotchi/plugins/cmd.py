...
from bananagotchi.utils import download_file, unzip, save_config, parse_version, md5
from bananagotchi.plugins import default_path


SAVE_DIR = '/usr/local/share/bananagotchi/available-plugins/'
DEFAULT_INSTALL_PATH = '/usr/local/share/bananagotchi/installed-plugins/'
...
def add_parsers(subparsers):
    ...
    # bananagotchi plugins uninstall
...
def edit(args, config):
    ...
    from bananagotchi.utils import DottedTomlEncoder
...
def list_plugins(args, config, pattern='*'):
    ...
    if not max_len_list:
        print('Maybe try: sudo bananagotchi plugins update')
        return 1
