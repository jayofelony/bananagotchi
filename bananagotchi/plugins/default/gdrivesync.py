...
from bananagotchi.utils import StatusFile
import zipfile
...
class GdriveSync(plugins.Plugin):
    ...
    __version__ = '1.2'
    __license__ = 'GPL3'
    __description__ = 'A plugin to backup various bananagotchi files and folders to Google Drive. Once every hour from loading plugin.'
        ...
        try:
            ...
            if not self.backup:
                ...
                if not backup_folder_file_list:
                    ...
                    # logging.warning(f"[gDriveSync] No files found in the folder with ID {root_file_list} and {bananagotchi_file_list}")
