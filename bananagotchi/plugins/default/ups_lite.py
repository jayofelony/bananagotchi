...
#
# Now, install this plugin by copying this to the 'available-plugins' folder in your bananagotchi, install and enable the plugin with the commands:
# sudo bananagotchi plugins install upslite_plugin_1_3
# sudo bananagotchi plugins enable upslite_plugin_1_3
#
...
# run the script we saved earlier and ensure that the bananagotchi is plugged in both at the battery and the raspberry pi. The script should start trying to
...
from bananagotchi.ui.components import LabeledValue
