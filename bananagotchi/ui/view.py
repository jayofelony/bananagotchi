...
from bananagotchi.ui.components import *
from bananagotchi.ui.state import State
from bananagotchi.voice import Voice
...
class View(object):
    def __init__(self, config, impl, state=None):
        ...
        self._state = State(state={
            ...
            'name': Text(value='%s>' % 'bananagotchi', position=self._layout['name'], color=BLACK, font=fonts.Bold),
