...
import bananagotchi
import bananagotchi.utils as utils
import bananagotchi.plugins as plugins
from bananagotchi.ui.web.server import Server
from bananagotchi.automata import Automata
from bananagotchi.log import LastSession
from bananagotchi.bettercap import Client
from bananagotchi.mesh.utils import AsyncAdvertiser
from bananagotchi.ai.train import AsyncTrainer

RECOVERY_DATA_FILE = '/root/.bananagotchi-recovery'
...
class Agent(Client, Automata, AsyncAdvertiser, AsyncTrainer):
    def __init__(self, view, config, keypair):
        Client.__init__(self,
                        ...
                        "bananagotchi" if "username" not in config['bettercap'] else config['bettercap']['username'],
                        "bananagotchi" if "password" not in config['bettercap'] else config['bettercap']['password'])
        ...
        logging.info("%s@%s (v%s)", bananagotchi.name(), self.fingerprint(), bananagotchi.__version__)
