...
class Voice:
    ...
    def on_starting(self):
        return random.choice([
            self._('Hi, I\'m bananagotchi! Starting ...'),
    ...
    def on_last_session_tweet(self, last_session):
        return self._(
            'I\'ve been pwning for {duration} and kicked {deauthed} clients! I\'ve also met {associated} new friends and ate {handshakes} handshakes! #bananagotchi #pwnlog #pwnlife #hacktheplanet #skynet').format(
