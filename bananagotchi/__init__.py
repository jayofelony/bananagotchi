...
from bananagotchi._version import __version__
...
def restart(mode):
    ...
    mode = mode.upper()
    if mode == 'AUTO':
        os.system("touch /root/.bananagotchi-auto")
    else:
        os.system("touch /root/.bananagotchi-manual")

    os.system("service bettercap restart")
    time.sleep(1)
    os.system("service bananagotchi restart")
