...
def update_data(last_session):
    ...
    try:
        ...
        pass
    enabled = [name for name, options in bananagotchi.config['main']['plugins'].items() if
               'enabled' in options and options['enabled']]
    language = bananagotchi.config['main']['lang']
    ai = bananagotchi.config['ai']['enabled']
    ...
    data = {
        ...
        'build': "bananagotchi by Jayofelony",
        'plugins': enabled,
        'language': language,
